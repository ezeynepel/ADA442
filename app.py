...
st.markdown("""
Use the form below to enter client information and predict whether the client will subscribe to a **bank term deposit**.

This model is trained on real marketing campaign data from a Portuguese bank.
""")
...
with st.form("prediction_form"):
    ...
    with col2:
        ...
        campaign = st.number_input("Campaign Contact Count", min_value=1, max_value=50, step=1, value=1)
...
if submitted:
    ...
    try:
        ...
        st.caption("This prediction is based on historical marketing data and may not reflect current behavior.")
